...
/**
 * Utility class for busListener.
 * @generated 
 * @wtp generated
 */
public class busListenerUtil
{
  ...
  private static final java.lang.String DESTINATION_JNDI_NAME="busListener";
  private static final java.lang.String CONNECTION_FACTORY_JNDI_NAME="";

   /**
    * Obtain destination queue from default initial context
    * @return Destination JMS Queue for busListener. Lookup using JNDI_NAME
    */
   ...
   /**
    * Obtain destination queue from default initial context
    * @return Destination JMS Connection Factory for busListener. Lookup using JNDI_NAME
    */
   ...
   public static final String generateGUID(Object o) {
       ...
       if (hexServerIP == null) {
           ...
           try {
               ...
               System.err.println("busListenerUtil: Could not get the local IP address using InetAddress.getLocalHost()!");
